...
' -- 인터넷 차단 자동 해제 (Zone.Identifier 스트림 삭제)
WshShell.Run "powershell -NonInteractive -WindowStyle Hidden -Command ""Remove-Item -LiteralPath '" & exe & "' -Stream Zone.Identifier -ErrorAction SilentlyContinue""", 0, True
